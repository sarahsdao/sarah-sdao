...
I am an experienced and dedicated remote worker, writer, editor, librarian, and communicator. I understand the perspective of software users and collaborates with developers to create documentation that works. I am also a quick learner who adapts well to new environments and builds positive relationships with partners and stakeholders.
...
- Works with developers to write concise, digestible, and accurate documentation for the Posit software products.
...
- Created technical documentation (training materials, support guides, and memorandums) to support the claims automations and procedures department.