...
- Works with developers to write concise, digestible, and accurate documentation for Posit software products including Posit Workbench, Posit Connect, Posit Package Manager, and the RStudio IDE.
...
- Maintains the Posit Style Guide with the technical writing team.
- Builds technical expertise through hands-on work with R, the RStudio IDE, Quarto features, and CSS for website styling.
